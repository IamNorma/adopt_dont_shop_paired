...
ActiveRecord::Schema.define(version: 20200708020143) do
  ...
  create_table "favorite_pets", force: :cascade do |t|
    ...
    t.index ["favorite_id"], name: "index_favorite_pets_on_favorite_id"
  ...
  add_foreign_key "favorite_pets", "favorites"
